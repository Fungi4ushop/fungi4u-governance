...
- **Follow-ups still open** (both listed in the bag-movement migration): guard `fn_record_picking` against batches with nothing in the fruiting room; have `fn_remove_batch` post a SPENT movement so removal and bag state cannot disagree.
