...
- **⬜ PRACTICAL, AND IT IS ONE PIN FOR BOTH: two DS18B20 probes on a single 1-Wire GPIO** *(GPIO21 is free)*. **ESPHome-native, waterproof stainless probes survive the ~90% RH airstream and the weather.** ⚠️ **Mount the outdoor probe on the SOUTH face — Pretoria is at −25.8°, so the sun sits to the NORTH and south-facing walls are the shaded ones** — and shield it from rain and radiant sky.
