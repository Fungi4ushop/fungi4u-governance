...
- **Two candidates, neither yet tested.** (1) **The 08-09 freeze and power-cycle** — the Inkbird was dark ~22h and returned 08-10 07:42; cheap NDIR units commonly re-derive their zero via automatic baseline correction after a reboot. (2) **The documented handling drift** on returning it to the shelf, which this file already records happening twice.
