...
### ⚠️ Anon grant leak — fix written 2026-07-28, NOT YET APPLIED

Found while testing the bag-movement migration. **`stock-control/supabase/migrations/20260728140000_revoke_default_anon_grants.sql`**, verified on a local stack.
