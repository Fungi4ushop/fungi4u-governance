...
- **One follow-up still open:** have `fn_remove_batch` post a SPENT movement so removal and bag state cannot disagree (the W23 artefact — 9 bags showing in grow while flagged removed).
